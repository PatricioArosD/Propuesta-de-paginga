...
const Architecture = () => {
  ...
  const stepIcons = ["🔍", "💡", "🚀", "🏭"];
  // Reemplazamos bg-deep-blue por bg-olive y ajustamos la secuencia
  const stepColors = ["bg-olive", "bg-muted-blue", "bg-mustard", "bg-olive"];
  ...
  return (
    <div className="container py-5 mb-5">
      <div className="text-center mb-5">
        ...
        <h1 className="text-olive fw-bold display-5 serif-font mb-3">{t.architecture.title}</h1>
      ...
      <div className="row text-center justify-content-center g-4 mt-5">
        {t.architecture.steps.map((item, idx) => (
          <div className="col-lg-3 col-md-6 timeline-step" key={idx}>
            ...
            <h4 className="text-olive fw-bold serif-font mb-3">{item.step}</h4>
